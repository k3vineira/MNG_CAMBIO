...
class PagoAdmin(admin.ModelAdmin):
    ...
    def get_readonly_fields(self, request, obj=None):
        if obj: # editing an existing object
            ...
            if obj.estado_transaccion in ['aprobado', 'rechazado']:
            ...
            return ('usuario', 'reserva', 'referencia', 'banco_origen', 'monto', 'imagen_comprobante', 'descripcion', 'fecha_pago', 'fecha_envio', 'fecha_revision')
    ...
    def has_delete_permission(self, request, obj=None):
        ...
        if obj and obj.estado_transaccion in ['aprobado', 'rechazado']:
            return False
